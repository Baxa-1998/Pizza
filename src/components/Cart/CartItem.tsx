...
import { onMinus, onPlus, setRemove } from '../../app/slices/cartSlice';
...
export const CartItem: React.FC<TProps> = ({ id, title, imageUrl, price, count, type }) => {
  ...
  return (
    <div className="cart__item" >
      ...
      <div onClick={onRemoveCart} className="cart__item-remove">
